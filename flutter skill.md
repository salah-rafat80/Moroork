...
# Scope (Global)
- These rules are GLOBAL and apply across the entire repository unless a task explicitly states otherwise.
- If guidance conflicts, follow this order: system/developer instructions, then `CLAUDE.md`, then feature-local notes.
